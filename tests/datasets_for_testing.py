...
df1_agg_sum = pd.DataFrame(
    {
        "delbydelid": [*SUB_DISTRICT, *SUM_SUB_DISTRICT],
        "date": [*DATE, *SUM_DATE],
...
df2_agg_Oslo = pd.DataFrame(
    {
        "date": [2017, 2018],
        "delbydelid": [np.nan, np.nan],
        "district": ["00", "00"],
        "mean_income": [460_000.0, 483_000.0],
...
trangboddhet_data = {
    "date": [2016, 2016, 2016, 2016, 2016, 2017, 2017, 2017, 2017, 2017],
    "delbydelid": [
        "0300010001",
        "0300010002",
        "0300020003",
