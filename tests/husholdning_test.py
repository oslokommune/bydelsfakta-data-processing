...
df_with_district_id = pd.read_csv(f'tests/husholdning_test_input.csv', sep=';', converters={
...
class Tester(unittest.TestCase):
    ...
    def test_with_data_points(self):
        ...
        self.assertCountEqual(with_data_points.to_dict('r'), test_data.with_data_points_expected)
